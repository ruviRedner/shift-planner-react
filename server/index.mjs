...
const app = createTeamServer({ store, dataFile: resolve(process.env.PLANNER_DATA_FILE ?? '.planner-data/team.json'),
...
app.server.listen(port, host, () => {
  ...
  if (needsSetup) console.log(`First administrator setup code: ${app.setupToken}`);
});
